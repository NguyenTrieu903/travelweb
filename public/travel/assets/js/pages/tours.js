(function () {
  ...
  function bookTour(name) {
    ...
    t.id = 'toast-inline';
    t.style.cssText = 'position:fixed;bottom:100px;right:32px;background:var(--nv);color:#fff;padding:14px 22px;border-radius:14px;font-size:.85rem;font-weight:600;box-shadow:0 8px 30px rgba(0,0,0,.25);z-index:8888;display:flex;align-items:center;gap:10px';
